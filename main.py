...
if __name__ == "__main__":
    ...
    input_files = sorted([f for f in os.listdir(data_path) if os.path.isfile(os.path.join(data_path, f))])
    for input_file in input_files:
        ...
        solution = do_sth_bis(books_count, libraries_count, days_count, book_scores, libraries)
